        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <h3 class="text-info"><b><i class="fas fa-desktop"></i> Aksesoris Komputer</h1>
                            </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="/admin" style="text-decoration: none">
                        {{ __('Admin') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link href="{{ route('products.index') }}" :active="request()->routeIs('products.index')" style="text-decoration: none">
                        {{ __('Produk') }}
                    </x-jet-nav-link>
